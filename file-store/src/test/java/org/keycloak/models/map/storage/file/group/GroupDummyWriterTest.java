...
//        addEntity(events, client);
        addEntityWithContext(events, client);
    ...
    private <E> void addEntityWithContext(List<Event> events, E entity) {
        Mech mech = new Mech(events);
        ClientYamlContext entityYamlContext = new ClientYamlContext(); //TODO make it non-client specific

        entityYamlContext.writeValue(entity, mech);
...
//                    YamlContext<?> context = entityYamlContext.getContext(fieldName);
//
