...
import static org.keycloak.models.map.storage.file.YamlContextAwareParser.ARRAY_CONTEXT;
...
public class MapEntityYamlContext<T> implements YamlContext<T> {
    ...
    private static class MapEntitySequenceYamlContext<T> extends DefaultListContext {
