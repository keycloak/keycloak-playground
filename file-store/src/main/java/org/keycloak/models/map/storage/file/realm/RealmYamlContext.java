...
public class RealmYamlContext extends MapEntityYamlContext<MapRealmEntity> {
    ...
    private static final Map<String, EntityField<? super MapRealmEntity>> NAME_TO_ENTITY_FIELD = fieldsToEntityField(MapRealmEntityFields.values());
    ...
    public RealmYamlContext() {
        super(new MapRealmEntityImpl(), NAME_TO_ENTITY_FIELD, CONTEXT_CREATORS);
    }
